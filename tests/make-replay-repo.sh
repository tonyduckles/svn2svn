...
## svn2svn /
#../svn2svn.py $* $PWDURL/_repo_ref $PWDURL/_repo_replay

# svn2svn /trunk
svn mkdir -q -m "Add /trunk" $REPOURL/trunk
../svn2svn.py $* $PWDURL/_repo_ref/trunk $PWDURL/_repo_replay/trunk

## svn2svn /trunk/Module2/ProjectB
#svn mkdir -q -m "Add /trunk" $REPOURL/trunk
#svn mkdir -q --parents -m "Add /trunk/Module2/ProjectB" $REPOURL/trunk/Module2/ProjectB
#../svn2svn.py $* $PWDURL/_repo_ref/trunk/Module2/ProjectB $PWDURL/_repo_replay/trunk/Module2/ProjectB
